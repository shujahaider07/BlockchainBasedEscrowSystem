...
<head runat="server">
    <title>Middle man  : Chat Page</title>
        ...
        <div class="content-wrapper">
            ...
            <header class="main-header" style="background: #bedaeb">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Middle man </b> Chat App</span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                   <p>Upload Your SreenShot here</p>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a class="btn btn-default btn-flat" data-toggle="modal" href="#ChangePic">Upload Picture</a>
                                        </div>
            ...
            <div class="modal-dialog" style="width: 700px">
                <div class="modal-content">
                    <div class="modal-header bg-light-blue-gradient with-border">
                        ...
                        <h4 class="modal-title">Upload ScreenShot/Agreement</h4>
                    </div>
